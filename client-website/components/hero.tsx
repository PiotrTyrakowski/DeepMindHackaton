    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Beautiful neighborhood with premium roofing"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Premium Roofing"}</p>
          ...
          >
            {"Roofs that protect"}
            <br />
            <span className="text-orange-200">{"and elevate homes"}</span>
          </h1>
        </div>
      </div>

      <div className="absolute bottom-0 left-0 right-0 z-20 pointer-events-none h-1/2">
        <div className="w-full h-full bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
      </div>
